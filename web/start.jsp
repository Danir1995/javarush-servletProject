...
<button class="btnRed" onclick="window.location='./deathByDogs.jsp'">SCREAM AND CRY</button>
<button class="btnGreen" onclick="window.location='./findHospital.jsp'">GO TO SEARCH SOMEBODY ALIVE</button>
